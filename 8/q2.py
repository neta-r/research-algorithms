...
def creat_matrix_from_sheet(sheet: gspread.worksheet.Worksheet):
    matrix = []
...
def output_to_sheet(output_sheet_name, spreadsheet: gspread.spreadsheet.Spreadsheet, output: numpy.ndarray):
...
def spread_sheet(A_sheet_name, B_sheet_name, output_sheet_name):
    ...
    A = creat_matrix_from_sheet(A_sheet)
    B = creat_matrix_from_sheet(B_sheet)
    Output = matmul(A, B)
